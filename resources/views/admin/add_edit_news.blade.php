...
<div class="form-group"> 
  <label class="col-md-2 control-label">Danh mục</label>
    ...
    <select name="fk_category_id" class="form-control selectpicker" >
      <?php
          ...
          ?>
            ...
            <option value="<?php echo $rows_cat->pk_category_id ?>" > <?php echo $rows_cat->c_name;?></option>
          <?php } ?>
    </select>
  </div>
</div>
...
<!-- radio checks -->
 <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="c_hot" value="2" /> New
                                </label>
                            
                                <label>
                                    <input type="radio" name="c_hot" value="1" /> Hot
                                </label>
                                <label>
                                    <input type="radio" name="c_hot" value="0" /> Nornal
                                </label>
                            </div>
                        </div>
                    </div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-text-width"></i></span>
  <input  placeholder="Link Img" class="form-control"  type="text" name="c_avt" value="<?php echo isset($arr->c_avt)?$arr->c_avt:""; ?>"  >
    </div>
    <img src="<?php echo isset($arr->c_avt)?$arr->c_avt:""; ?>" width=100px>
  </div>
</div>
<!-- language -->
<div class="form-group"> 
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <a href="{{ url('admin\news') }} }}"><button  class="btn btn-warning" >Trở lại<span class="glyphicon glyphicon-arrow-left"></span></button></a>
  </div>
</div>
