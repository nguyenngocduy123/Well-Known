...
<div class="form-group">
  ...
  <input  placeholder="vị trí" class="form-control"  type="text" name="c_position" value="<?php echo isset($slide->c_position)?$slide->c_position:""; ?>">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-text-width"></i></span>
  <input  placeholder="Link Img" class="form-control"  type="text" name="c_img" value="<?php echo isset($slide->c_img)?$slide->c_img:""; ?>"  >
    </div>
    <img src="<?php echo isset($slide->c_img)?$slide->c_img:""; ?>" width=500px>
  </div>
</div>
<!-- language -->
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <a href="{{ url('admin\slide') }} }}"><button  class="btn btn-warning" >Trở lại<span class="glyphicon glyphicon-arrow-left"></span></button></a>
  </div>
</div>
